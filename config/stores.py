...
DAIDATA_STORES = {
    ...
    'seibu_shinjuku_espass': {
        ...
        'name': '西武新宿駅前エスパス',
        'machines': {
            'sbj': ['3185', '3186', '3187'],  # 4000番台(4109,4118,4125,4168)は低貸(6.3円/2.5円)のため除外
            'hokuto_tensei2': ['3144', '3145', '3146', '3147', '3148', '3149', '3150', '3151', '3165', '3166'],
        },
    },
}
...
PAPIMO_STORES = {
    'island_akihabara': {
        ...
        'machines': {
            ...
            'hokuto_tensei2': [
                '0731', '0732', '0733', '0735', '0736', '0737', '0738',
