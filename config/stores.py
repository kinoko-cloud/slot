...
DAIDATA_STORES = {
    ...
    'seibu_shinjuku_espass': {
        ...
        'machines': {
            ...
            'hokuto2': ['3138', '3139', '3140', '3141', '3142', '3143', '3144', '3145', '3146', '3147', '3148', '3149', '3150', '3151', '3165', '3166'],
        },
    },
    'shibuya_honkan_espass': {
        ...
        'machines': {
            'sbj': ['3095', '3096', '3097'],
            'hokuto2': [str(i) for i in range(2013, 2020)] + [str(i) for i in range(2030, 2038)],
        },
    },
}
