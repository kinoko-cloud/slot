...
STORES = {
    ...
    'shinjuku_espass_sbj': {
        ...
        'hall_id': '100949',
        'machine': 'sbj',
        'units': [],  # 2026-04-29: 669-672に移動。2026-04-29: 予測精度低下のため除外
        'data_source': 'daidata',
    },
    ...
    'akiba_espass_sbj': {
        ...
        'hall_id': '100928',
        'machine': 'sbj',
        'units': [],  # 2026-04-29: 2070-2072に移動・減台。2026-04-29: 予測精度低下のため除外
        'data_source': 'daidata',
    },
    # === 真打吉宗 ===
    ...
    'shinjuku_espass_yoshimune': {
        ...
        'hall_id': '100949',
        'machine': 'yoshimune',
        'units': [],  # 2026-04-30: 予測精度改善のため除外 (元: 682-695)
        'data_source': 'daidata',
    },
    'akiba_espass_yoshimune': {
        ...
        'hall_id': '100928',
        'machine': 'yoshimune',
        'units': [],  # 2026-04-30: 予測精度改善のため除外 (元: 2001-2010)
        'data_source': 'daidata',
    },
    ...
    'shinjuku_espass_toloveru': {
        ...
        'hall_id': '100949',
        'machine': 'toloveru',
        'units': [],  # 2026-04-30: 予測精度改善のため除外 (元: 1389-1391)
        'data_source': 'daidata',
    },
    'akiba_espass_toloveru': {
        ...
        'hall_id': '100928',
        'machine': 'toloveru',
        'units': [],  # 2026-04-30: 予測精度改善のため除外 (元: 3075-3087, 3150-3166)
        'data_source': 'daidata',
    },
