...
STORES = {
    ...
    'seibu_shinjuku_espass_hokuto2': {
        ...
        'hall_id': '100950',
        'machine': 'hokuto2',
        'units': ['3140', '3141', '3142', '3143', '3144', '3145', '3146', '3147', '3165', '3166'],  # 3139除外: Lスマスロ北斗に台変動(2026-03-04確認), 3148-3151除外: LモンキーターンVに台変動(2026-03-04確認)
        'data_source': 'daidata',
    },
    'akiba_espass_sbj': {
        'name': 'エスパス日拓秋葉原駅前店',
    ...
    'akiba_espass_hokuto2': {
        ...
        'hall_id': '100928',
        'machine': 'hokuto2',
        'units': ['2011', '2012', '2013', '2014', '2015', '2016', '2019', '2057', '2058', '2059', '2061', '2062', '2063', '2066', '2067'],  # 2056,2060除外: Lﾏｷﾞｱﾚｺｰﾄﾞ, 2017,2018,2064,2065除外: パチンコ台変動(2026-03-02確認), 2060除外: Lﾏｷﾞｱﾚｺｰﾄﾞ(2026-03-03確認)
        'data_source': 'daidata',
    },
    'island_akihabara_hokuto2': {
        ...
        'hall_id': None,
        'machine': 'hokuto2',
        'units': [],  # 0811-0825全台: 台変動(3/2確認、全台別機種)
        'data_source': 'papimo',
    },
    # === 追加店舗 (2026-02-14) ===
    'ueno_espass_sbj': {
