...
STORES = {
    ...
    'akiba_espass_sbj': {
        ...
        'hall_id': '100928',
        'machine': 'sbj',
        'units': ['2070', '2071', '2072'],  # 2026-04-29: 2157-2160から移動・減台 (4台→3台)
        'data_source': 'daidata',
    },
    # === 真打吉宗 ===
    ...
    'seibu_shinjuku_espass_yoshimune': {
        ...
        'hall_id': '100950',
        'machine': 'yoshimune',
        'units': [],  # 2026-04-30: 予測精度改善のため除外 (元: 3111-3115)
        'data_source': 'daidata',
    },
    'shibuya_espass_yoshimune': {
        ...
        'hall_id': '100860',
        'machine': 'yoshimune',
        'units': [],  # 2026-04-30: 予測精度改善のため除外 (元: 3047-3053, 3090)
        'data_source': 'daidata',
    },
    # === ToLOVEるDARKNESS ===
    ...
    'seibu_shinjuku_espass_toloveru': {
        ...
        'hall_id': '100950',
        'machine': 'toloveru',
        'units': [],  # 2026-04-30: 予測精度改善のため除外 (元: 3195-3197)
        'data_source': 'daidata',
    },
    'shibuya_espass_toloveru': {
        ...
        'hall_id': '100860',
        'machine': 'toloveru',
        'units': [],  # 2026-04-30: 予測精度改善のため除外 (元: 3010-3012)
        'data_source': 'daidata',
    },
}
