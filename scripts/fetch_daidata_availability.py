...
DAIDATA_STORES = {
    ...
    'takadanobaba_espass_hokuto2': {
        ...
        'name': 'エスパス高田馬場',
        'model_encoded': 'L%E5%8C%97%E6%96%97%20%E8%BB%A2%E7%94%9F%E3%81%AE%E7%AB%A02',
        'units': ['2103', '2104', '2105', '2106', '2107', '2108', '2109', '2110', '2111', '2112', '2170', '2171', '2172', '2173', '2174', '2175', '2176', '2192'],
    },
    ...
    'shinkoiwa_espass_hokuto2': {
        ...
        'name': '新小岩エスパス',
        'model_encoded': 'L%E5%8C%97%E6%96%97%20%E8%BB%A2%E7%94%9F%E3%81%AE%E7%AB%A02',
        'units': ['2167', '2168', '2169', '2170', '2171', '2172', '2173', '2216', '2217', '2218', '2219', '2220', '2221', '2222', '2223', '2224', '2225', '2226', '2227', '2228', '2229', '2230', '2231', '2232', '2233', '2234', '2235', '2236'],
    },
}
